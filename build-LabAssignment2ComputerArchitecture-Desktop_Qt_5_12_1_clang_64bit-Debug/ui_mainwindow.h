...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy2.setHeightForWidth(BocinasspinBox->sizePolicy().hasHeightForWidth());
        BocinasspinBox->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(VehiculoGuardadoCargarspinBox->sizePolicy().hasHeightForWidth());
        VehiculoGuardadoCargarspinBox->setSizePolicy(sizePolicy3);
        ...
        sizePolicy2.setHeightForWidth(MatriculalineEdit->sizePolicy().hasHeightForWidth());
        MatriculalineEdit->setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(VehiculosGuardadoslcdNumber->sizePolicy().hasHeightForWidth());
        VehiculosGuardadoslcdNumber->setSizePolicy(sizePolicy3);
        ...
        gridLayout_4->addWidget(textEdit, 0, 1, 4, 2);
